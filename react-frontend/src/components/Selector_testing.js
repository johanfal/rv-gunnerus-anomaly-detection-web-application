...
export class Selector extends React.Component {
    constructor(props){
        ...
        this.chart_values = {} // values of currently selected signals at given time
    }
    socket;
    ...
    componentDidMount() {
        ...
        this.connect(); // connect websocket between client and server

        this.socket.on('values', (values) => {
            if(this.state.selected.length > 0){
                // var chart_items = this.state.chart_items;
                console.log(values)
    ...
    componentDidUpdate(_prev_props, prev_state){
        ...
        // if(sio_status){
            ...
            // chart_items = this.set_chart_values(chart_items,selected)
        // }
