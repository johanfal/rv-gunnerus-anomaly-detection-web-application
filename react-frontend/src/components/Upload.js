  ...
  const onDrop = useCallback((acceptedFiles, fileRejections) => {
    ...
    if(acceptedFiles.length > 1){
      ...
      if(nl > MAX_FILENAME_LENGTH + fl){
          name = name.substring(0,15) + '...' +
                  name.substring(nl-fl-3, nl-fl) + fileExtension
        }
        setFilename(name);
      }
    });
        ...
        fetch(
          ...
          response.json().then((data) => {
            if(data.fileprops !== false){
              ...
              props.sendModelProperties({input:null,output:null,timesteps:null})
            }
    ...
    const {
      ...
      const getFileSummary = (id) => {
        ...
        if(!fileProperties){
          return <div id="fileprops-error" style={{color: 'red'}}>
          <br/>
          <em>
            Could not read {props.name} properties..
          </em>
          </div>
        }
        ...
        if(id === 'keras-model'){
          return !metadataReceived ? <em>
            ...
            <em>Specifications found for uploaded model:</em><br/>
        ...
        if(id === 'scaler'){
          ...
          <br/>
            ...
            <em>Specifications found for uploaded scaler:</em><br/>
          ...
          <div {...getRootProps({style})} className="upload">
            <input {...getInputProps()} />
              ...
              !uploaded ?
                [<div>
                <br/>
                  Drag and drop {props.name} here,<br/>or click to select from files.
                  <br/><br/><br/>
